        ...
        >
          ...
          >
            ...
            <div style={{marginTop:"2rem",display:"flex",width:"100%",alignItems:"center",justifyContent:"space-between"}}>
              ...
              <InnerText>24h%<img src={Updown} alt="down"/></InnerText>
              <InnerText>7d%</InnerText>
              <InnerText>Floor Price<img src={Updown} alt="down"/></InnerText>
              </div>
              <div style={{width:"20%",display:"flex",justifyContent:"space-between"}}>
              <InnerText>Owners<img src={Updown} alt="down"/></InnerText>
              <InnerText>Items<img src={Updown} alt="down"/></InnerText>
              </div>
            </div>
            <div style={{width:"100%",overflow:"auto",height:"50rem",marginTop:"2rem"}}>
                <TopCollectionCard/>
                <TopCollectionCard/>
                <TopCollectionCard/>
                <TopCollectionCard/>
